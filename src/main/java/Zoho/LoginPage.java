...
public class LoginPage extends ZohoWebtesting{
	...
	public void clickSignIn() throws InterruptedException {
		signIn.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='login_id']")).sendKeys("shahrukhg@gmail.com");
		nextButton.click();
		Thread.sleep(5000);
...
//		Thread.sleep(5000);				
//		WebElement element = driver.findElement(By.xpath("//input[@id= 'Crm_Leads_PHONE_LInput']"));
//		js.executeScript("arguments[0].scrollIntoView();", element);
	...
	driver.findElement(By.xpath("//input[@id='Crm_Leads_LASTNAME_LInput']")).sendKeys("Saifi");
	Thread.sleep(2000);
	saveLead.click();
